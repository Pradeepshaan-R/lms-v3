...
import { cilEyedropper, cilPlus } from '@coreui/icons'
      ...
      <CCard>
        <CCardBody>
          <CCardTitle>
            <div className="row">
              <h5 className="col-10">
                Assignment <span className="text-muted">List</span>
              </h5>
              <div className="col-2 d-md-flex justify-content-md-end">
                <CTooltip content="Add New">
                  <CNavLink to="/assignment/create" component={NavLink} activeClassName="active">
                    <CButton className="btn btn-success text-white btn-sm">
